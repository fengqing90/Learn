...
import cn.fengqing.learnthrift.impl.CalculatorHandler;
...
public class JavaServer {
    ...
    public static void secure(Calculator.Processor processor) {
        try {
             ...
             * In this example
             * we are setting the keystore and the keystore password. Other
             ...
             * SSL configuration. You can use the default settings if properties
