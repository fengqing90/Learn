...
@Service("billCancelService")  
@RequestMapping("/bill/cancel")  
public class BillCancelService implements BillApi, CompensableContextAware {
	...
	public void add(Bill bill) {
		...
		billMapper.cancelCreateBill(refillOrderId); 
		System.out.println(new Date() + ": cancel创建账单接口");  
	}
