...
public class MD5 {
    ...
    private final int s[] = { 7, 12, 17, 22, 7, 12, 17, 22, 7, 12, 17, 22, 7,
        12, 17, 22, 5, 9, 14, 20, 5, 9, 14, 20, 5, 9, 14, 20, 5, 9, 14, 20, 4,
    ...
    private void MainLoop(int M[]) {
        ...
        for (int i = 0; i < 64; i++) {
            ...
            d = c;
            c = b;
            b = b + this.shift(a + F + this.K[i] + M[g], this.s[i]);
            a = tmp;
        }
        this.Atemp = a + this.Atemp;
        this.Btemp = b + this.Btemp;
        this.Ctemp = c + this.Ctemp;
        this.Dtemp = d + this.Dtemp;
    ...
    public String getMD5(String source) {
        ...
        return this.changeHex(this.Atemp) + this.changeHex(this.Btemp)
            + this.changeHex(this.Ctemp) + this.changeHex(this.Dtemp);
    ...
    public static void main(String[] args) {
        String str = MD5.getInstance().getMD5("sec007urity");
