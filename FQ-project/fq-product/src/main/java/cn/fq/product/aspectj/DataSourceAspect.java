...
public class DataSourceAspect {
    ...
    @Pointcut("@annotation(cn.fq.common.annotation.DataSource)"
        + "|| @within(cn.fq.common.annotation.DataSource)")
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        if (dataSource != null) {
            ...
            DynamicDataSourceContextHolder
                .setDataSourceType(dataSourceType.name());
            logger.info("【切换数据】 = {}", dataSourceType);
        }
